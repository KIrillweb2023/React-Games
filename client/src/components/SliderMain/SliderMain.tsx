...
export const SliderMain = () => {
    ...
    const SubmitGame = async (values: GameCreateData) => {
    ...
    return (
        <Swiper spaceBetween={0} slidesPerView={1} loop={true} className='swiper-wrapper'>
            {
                        ...
                        <SwiperSlide key={index}>
                            <div className='swiper-slide-content'>
                                ...
                                <div className='swiper-slide-block'>
                                    <div className="swiper-slide-blockText">
